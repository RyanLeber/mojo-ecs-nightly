...
def main():
    ...
    var player = ecs.add_entity(Body(Vector2(50, 50), 200, position=Vector2(0, 0)))
    ...
    while running:
        ...
        ecs_player_movement(ecs, player, keyboard)
        ecs_player_jump(ecs, physics_engine, player, ground, keyboard)
